      ...
      <div className="row">
        ...
        <div className="col-6 col-md">
          ...
          <ul className="list-unstyled text-small">
            <li><a className="link-secondary text-decoration-none" href="/">AI Mini-Apps Design</a></li>
        ...
        <div className="col-6 col-md">
          <h5>GitHub</h5>
          <ul className="list-unstyled text-small">
            <li><a className="link-secondary text-decoration-none" href="https://github.com/DappyKit/" target="_blank">DappyKit</a></li>
        ...
        <div className="col-6 col-md">
          <h5>Contact</h5>
          <ul className="list-unstyled text-small">
            <li><a className="link-secondary text-decoration-none" href="mailto:dappykit@gmail.com">Email</a></li>
        ...
        <div className="col-6 col-md">
          <h5>About</h5>
          <ul className="list-unstyled text-small">
            <li><a className="link-secondary text-decoration-none" href="https://warpcast.com/dappykit" target="_blank" rel="noopener">Team</a></li>
